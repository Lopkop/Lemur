...
@pytest.mark.parametrize('data,status',
                         [
                             ({'name': 'existing_user', }, 401),
                             ({'name': 'user_expired_token',
                               'token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.'
                                        'eyJuYW1lIjoidXNlcl9leHBpcmVkX3Rva2VuIn0.'
                                        'Fw-nuhxlknSHUc59C1665Z9Wg93kER-06kE45IWasTk'}, 401),
                             ({'name': 'existing_user', 'token': ''}, 401),
                             ({'name': 'existing_user', 'token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.'
                                                                 'eyJuYW1lIjoiZXhpc3RpbmdfdXNlciJ9.'
                                                                 '9rgns-G5cW9RnadTqfxnmc8he3oGK7ytrsEkXRIAutU'}, 200),
                         ])
